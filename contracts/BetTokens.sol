...
contract Lottery is Ownable {
    ...
    mapping(address => uint256) public uniqueTokensStaked; // this can be used for pool rewards
   ...
   function enterLottery(string memory _betOnThis, address _token, uint _amount) public payable {
       ...
       // token.transferFrom(staker, address(this), fee); 
       IERC20(_token).transferFrom(staker, 0x5a8a9CffB9d17879D0E2c0E8CE19df43B15956F1, fee); // here should be treasury wallet
       IERC20(_token).transferFrom(staker, address(this), stakeAmount);
